<div class="min-h-screen bg-white py-4 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div class="relative px-4 py-4 bg-white shadow-lg sm:rounded-3xl sm:p-12">
            <div class="space-y-4 px-6 lg:px-8">
                ...
                <form class="space-y-4" action="<?php echo URLROOT ?>/admin/login" method="POST" id="loginForm">
                    <div>
