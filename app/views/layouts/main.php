                ...
                <div>
                    ...
                    <div id="menu" class="md:block lg:block hidden" style="font-family: 'Poppins', sans-serif;">
                        ...
                        <ul class="flex flex-col gap-6 text-3xl md:text-base items-center justify-center  bg-white  md:flex-row md:bg-transparent z-20">
                            <li>
                                <a href="<?php echo URLROOT ?>/pages" class="inline-block rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm ring-1 ring-green-600 ring-inset bg-green-600  hover:ring-green-600 hover:ring-0 hover:bg-green-600 hover:text-white">Home</a>
                            </li>
